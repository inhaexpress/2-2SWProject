...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo01" aria-controls="navbarTogglerDemo01" aria-expanded="false" aria-label="Toggle navigation">
   ...
   <table border = "3px solid black;" width=100% height=100% style="background-color:white; margin-top:10px;">
      <tr>
         <td width="300"><img src="small/Portal2.jpeg" border = "3px solid black;"></td>
         <td width="400" class="w-50 p-3">
            ...
            <table border="0">
            	...
            	<tr>
            		<td>> 장르</td>
            		<td>&nbsp;&nbsp;&nbsp;1인칭 퍼즐 플랫포머/FPS</td>
            	</tr>
            	<tr>
            		<td>> 제작사</td>
            		<td>&nbsp;&nbsp;&nbsp;<a href="https://www.valvesoftware.com/en/" target="_blank">밸브 코퍼레이션</a></td>
            	</tr>
            	<tr>
            		<td>> 이용등급</td>
            		<td>&nbsp;&nbsp;&nbsp;12세 이용가</td>
            	...
            	<tr>
            		<td colspan="2">
            			<input type="submit"  class="btn btn-outline-dark" value="관련사이트" onClick="window.open('http://www.thinkwithportals.com/')">
            		</td>
            	</tr>
            </table>
         </td>
			...
			<table class="table table-hover" style="text-align: center; border: 2px solid black;">
				...
				<tbody>
					...
					for (int i = 0; i < list.size(); i++) {
						...
						if(list.get(i).getBbsCategory().equals("portal")) {
							category = "포탈2";
					%>
					<tr>
						<td>
		 ...
		 <li class="nav-item" style="background-color:black; border:2px solid white;"><a class="nav-link" data-toggle="tab" href="#1" style="color:white;">게임 설명</a></li>
			...
			<div class="tab-content">
				 <div class="tab-pane fade show active" id="1">
				 	...
				 	포탈 2의 싱글 플레이어는 생동감 있는 새 캐릭터와 다수의 새로운 퍼즐들, 그리고 더욱 거대하고 복잡한 실험실을 소개합니다.<br><br>

					포털 2는 오리지널 포털이 70개가 넘는 게임상을 수상할 수 있게 한 혁신적인 게임 플레이 방식과 스토리, 음악을 탄생시키고 <br>
					컬트적인 팬층을 만들어낸 바로 그 공식을 따라 만들어졌습니다.<br><br>

					포털 2의 싱글 플레이어는 생동감있는 새 캐릭터와 다수의 새로운 퍼즐들, 그리고 더욱 거대하고 복잡한 실험실을 소개합니다.<br> 
					플레이어는 예전에는 가볼 수 없었던 애퍼처 사이언스 연구소의 다른 지역들을 탐험하고, <br>
					전작에서 그들을 인도하던 악명 높은 인공지능 컴퓨터인 GLaDOS와 재회하게 됩니다.<br><br>

					새로운 협동 모드에서는 별도의 캠페인과 독특한 스토리, 실험실과 함께 새로운 플레이어 캐릭터 둘을 선보입니다. <br>
					이 새로운 모드는 플레이어들이 포털에 대해 알고 있다고 생각하던 기존의 모든 것을 재고하게끔 합니다. <br>
					협동적으로 행동하는 것만으로는 충분치 않습니다. <br>
					오로지 협동적으로 생각해야만 실험을 성공적으로 통과할 수 있습니다.<br><br>
				 ...
				 <div class="tab-pane fade show" id="2">
				 	<table border="0">
				 		<tr>
				 			<td>
				 				<iframe width="265" height="150" src="https://www.youtube.com/embed/V7ymD48fnDg/0.jpg" 
				 				title="YouTube video player" frameborder="0" 
				 				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
				 				allowfullscreen></iframe>
				 				<iframe width="265" height="150" src="https://www.youtube.com/embed/nLxGEAXhZgU/0.jpg" 
				 				title="YouTube video player" frameborder="0" 
				 				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
				 				allowfullscreen></iframe>
				 				<iframe width="265" height="150" src="https://www.youtube.com/embed/A88YiZdXugA/0.jpg" 
				 				title="YouTube video player" frameborder="0" 
				 				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
				 				allowfullscreen></iframe>
				 				<iframe width="265" height="150" src="https://www.youtube.com/embed/A0K5EXfgJnk/0.jpg" 
				 				title="YouTube video player" frameborder="0" 
				 				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
				 				allowfullscreen></iframe>
				 			</td>
				 		...
				 		<tr>
				 			<td>
				 				<iframe width="265" height="150" src="https://www.youtube.com/embed/tax4e4hBBZc/0.jpg" 
				 				title="YouTube video player" frameborder="0" 
				 				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
				 				allowfullscreen></iframe>
				 				<iframe width="265" height="150" src="https://www.youtube.com/embed/NoDqOy6SUfk/0.jpg" 
				 				title="YouTube video player" frameborder="0" 
				 				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
				 				allowfullscreen></iframe>
				 				<iframe width="265" height="150" src="https://www.youtube.com/embed/EZ_bi6DX1OU/0.jpg" 
				 				title="YouTube video player" frameborder="0" 
				 				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
				 				allowfullscreen></iframe>
				 				<iframe width="265" height="150" src="https://www.youtube.com/embed/r8E7vTb6wys/0.jpg" 
				 				title="YouTube video player" frameborder="0" 
				 				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
				 				allowfullscreen></iframe>
				 			</td>
