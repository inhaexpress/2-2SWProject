...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo01" aria-controls="navbarTogglerDemo01" aria-expanded="false" aria-label="Toggle navigation">
   ...
   <table border = "3px solid black" width=100% height=100% style="background-color:white; margin-top:10px;">
      <tr>
         <td width="300"><img src="small/Babaisyou.jpeg" border = "4px solid black"></td>
         <td width="400" class="w-50 p-3">
            ...
            <table border="0">
            	...
            	<tr>
            		<td colspan="2">
            			<input type="submit" class="btn btn-outline-dark" value="관련사이트" onClick="window.open('https://www.hempuli.com/baba/')">
            		</td>
            	</tr>
            </table>
         </td>
         ...
         <td colspan="3">
			...
			<div class="tab-content">
				 <div class="tab-pane fade show active" id="1" >
				 	...
				 	본래는 특정한 주제가 주어지고, 주어진 시간 동안 게임을 제작하는 Nordic Game Jam 콘테스트에서 2017년 "Not There"라는 주제로 우승한 작품이다. <br>
				 	제작자는 Hempuli라는 예명을 쓰는 핀란드인 아르비 테이카리(Arvi Teikari)로 콘테스트 당시 헬싱키 대학의 대학생이었다. <br>
				 	당시 획기적인 아이디어로 이목을 끈 바 있다. 이 당시에 만들어진 프로토타입을 기반으로 삼아 정식으로 만들어진 게 지금의 게임이다.<br><br>
						
					2021년 6월 23일, 모바일용(안드로이드, iOS)으로도 출시됐다.<br>
				 ...
				 <div class="tab-pane fade show" id="2">
				 	<table border="0">
				 		<tr>
				 			<td>
				 				<iframe width="265" height="150" src="https://www.youtube.com/embed/wAJvK0ZcMEA/0.jpg" 
				 				title="YouTube video player" frameborder="0" 
				 				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
				 				allowfullscreen></iframe>
				 				<iframe width="265" height="150" src="https://www.youtube.com/embed/nl4CRkd9W3I/0.jpg" 
				 				title="YouTube video player" frameborder="0" 
				 				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
				 				allowfullscreen></iframe>
				 				<iframe width="265" height="150" src="https://www.youtube.com/embed/bsWPZJ1q27g/0.jpg" 
				 				title="YouTube video player" frameborder="0" 
				 				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
				 				allowfullscreen></iframe>
				 				<iframe width="265" height="150" src="https://www.youtube.com/embed/XNPeOl53qPc/0.jpg" 
				 				title="YouTube video player" frameborder="0" 
				 				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
				 				allowfullscreen></iframe>
				 			</td>
				 		...
				 		<tr>
				 			<td>
				 				<iframe width="265" height="150" src="https://www.youtube.com/embed/ZyP6dXAKZV4/0.jpg" 
				 				title="YouTube video player" frameborder="0" 
				 				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
				 				allowfullscreen></iframe>
				 				<iframe width="265" height="150" src="https://www.youtube.com/embed/CyBXU48FTYE/0.jpg" 
				 				title="YouTube video player" frameborder="0" 
				 				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
				 				allowfullscreen></iframe>
				 				<iframe width="265" height="150" src="https://www.youtube.com/embed/WqJ7lf9qJL8/0.jpg" 
				 				title="YouTube video player" frameborder="0" 
				 				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
				 				allowfullscreen></iframe>
				 				<iframe width="265" height="150" src="https://www.youtube.com/embed/ht8n-LC2vE8/0.jpg" 
				 				title="YouTube video player" frameborder="0" 
				 				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
				 				allowfullscreen></iframe>
				 			</td>
