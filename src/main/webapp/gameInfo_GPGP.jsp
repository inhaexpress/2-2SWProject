...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo01" aria-controls="navbarTogglerDemo01" aria-expanded="false" aria-label="Toggle navigation">
   ...
   <table border = "3px solid black;" width=100% height=100% style="background-color:white; margin-top:10px;">
      <tr>
         <td width="300"><img src="small/GPGP.png" border="3px solid black"></td>
         <td width="400" class="w-50 p-3">
            ...
            <table border="0">
            	...
            	<tr>
            		<td colspan="2">
            			<input type="submit"  class="btn btn-outline-dark"  value="관련사이트" onClick="window.open('http://www.goodpizzagreatpizza.com/')">
            		</td>
            	</tr>
            </table>
         </td>
			...
			<table class="table table-hover" style="text-align: center; border: 2px solid black;">
				...
				<tbody>
					...
					for (int i = 0; i < list.size(); i++) {
						...
						if(list.get(i).getBbsCategory().equals("gpgp")) {
							category = "좋은피자, 위대한피자";
					%>
					<tr>
						<td>
         ...
         <td colspan="3">
			...
			<div class="tab-content">
				 <div class="tab-pane fade show active" id="1">
				 	...
				 	미국의 타이쿤 게임 전문 개발사 TapBlaze에서 제작한 타이쿤 종류 게임. 일명 좋피위피. <br>
				 	유명 피자가게 바로 앞에 피자가게를 새로 개업한 비범한 주인공의 이야기다.<br><br>

					처음엔 도우와 소스, 치즈, 페퍼로니만 주어지지만, 게임을 진행하면서 피자를 만들고 판매한 돈으로 재료들을 해금할 수 있다. <br>
					재료를 해금해도 사용할 때마다 재료비가 들지만 가지처럼 유저가 직접 키울 경우 재료비가 들지 않는다. <br>
					메인 스토리는 4장까지 존재하며(4.0.7 기준) 각장마다 새로운 토핑, 이벤트, 가게를 꾸밀 수 있는 장식이 해금된다.<br><br>
				 ...
				 <div class="tab-pane fade show" id="2">
				 	<table border="0">
				 		<tr>
				 			<td>
				 				<iframe width="265" height="150" src="https://www.youtube.com/embed/OcJY_Ut3OIk/0.jpg" 
				 				title="YouTube video player" frameborder="0" 
				 				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
				 				allowfullscreen></iframe>
				 				<iframe width="265" height="150" src="https://www.youtube.com/embed/jHMBhENrUQ0/0.jpg" 
				 				title="YouTube video player" frameborder="0" 
				 				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
				 				allowfullscreen></iframe>
				 				<iframe width="265" height="150" src="https://www.youtube.com/embed/gq6EUptRwwU/0.jpg" 
				 				title="YouTube video player" frameborder="0" 
				 				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
				 				allowfullscreen></iframe>
				 				<iframe width="265" height="150" src="https://www.youtube.com/embed/499q1O0N_Sg/0.jpg" 
				 				title="YouTube video player" frameborder="0" 
				 				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
				 				allowfullscreen></iframe>
				 			</td>
				 		...
				 		<tr>
				 			<td>
				 				<iframe width="265" height="150" src="https://www.youtube.com/embed/JV_WTiYM0BQ/0.jpg" 
				 				title="YouTube video player" frameborder="0" 
				 				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
				 				allowfullscreen></iframe>
				 				<iframe width="265" height="150" src="https://www.youtube.com/embed/OWbGqpGRsyQ/0.jpg" 
				 				title="YouTube video player" frameborder="0" 
				 				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
				 				allowfullscreen></iframe>
				 				<iframe width="265" height="150" src="https://www.youtube.com/embed/WtGJbw_COyI/0.jpg" 
				 				title="YouTube video player" frameborder="0" 
				 				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
				 				allowfullscreen></iframe>
				 				<iframe width="265" height="150" src="https://www.youtube.com/embed/FuFyQFQkHVs/0.jpg" 
				 				title="YouTube video player" frameborder="0" 
				 				allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
				 				allowfullscreen></iframe>
				 			</td>
